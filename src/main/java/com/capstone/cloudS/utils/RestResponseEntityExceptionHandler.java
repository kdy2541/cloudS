package com.capstone.cloudS.utils;

import com.capstone.cloudS.dto.CommonResponse;
import com.capstone.cloudS.dto.CommonResponseError;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<CommonResponseError> customHandleConstraintViolationException(ConstraintViolationException e, WebRequest request){
        CommonResponseError res = new CommonResponseError();
        res.setStatus("400");
        res.setMessage(e.getMessage());
        return new ResponseEntity<>(res,HttpStatus.BAD_REQUEST);
